                    ...
                    <View style={styles.overlayContentContainer}>
                        <View style={styles.topRowGroup}>
                            <View style={styles.topRow}>
                                <View><Text style={styles.name}>{props.name}</Text></View>
                                <View style={styles.starRating}>
                                    <Ionicons style={styles.starIcon} name="ios-star" size={16} color="white" />
                                    <Ionicons style={styles.starIcon} name="ios-star" size={16} color="white" />
                                    <Ionicons style={styles.starIcon} name="ios-star" size={16} color="white" />
                                    <Ionicons style={styles.starIcon} name="ios-star" size={16} color="white" />
                                    <Ionicons style={styles.starIcon} name="ios-star-half" size={16} color="white" />
                                </View>
                            </View>
                            <View style={styles.secondRow}>
                                <View><Text style={styles.location}>Location</Text></View>
                                <View><Text style={styles.reviewCount}>30 reviews</Text></View>
                            </View>
                        </View>
